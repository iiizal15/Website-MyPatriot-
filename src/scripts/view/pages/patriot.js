...
import {createCardPatriotTemplate} from './templates/template-creator'
...
const Patriot = {
    ...
    async afterRender(){
        ...
        const headerPatriot = document.querySelector('#patriot-header');
